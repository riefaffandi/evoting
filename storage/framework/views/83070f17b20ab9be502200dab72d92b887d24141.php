<div class="form-floating mb-3">
    <input type="number" class="form-control" id="username" name="username" placeholder="username" min="1"
        value="<?php echo e(old('username', $profile->username)); ?>" autofocus required>
...
<div class="form-floating mb-3">
    ...
    <button class="btn btn-outline-secondary position-absolute top-50 end-0 translate-middle-y" type="button"
        id="togglePassword">
        <i class="bi bi-eye"></i>
    </button>
...
<div class="form-floating mb-3">
    <input type="date" class="form-control" id="birth_date" name="birth_date" min="1960-01-01" max="2004-01-01"
        value="<?php echo e(old('birth_date', $profile->birth_date)); ?>" required>
...
<?php /**PATH C:\laragon\www\evoting\resources\views/components/form-user.blade.php ENDPATH**/ ?>