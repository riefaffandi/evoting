        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content border-0">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg">
                            <form action="<?php echo e(route('admin.index')); ?>" method="post" id="formDataAdmin">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH D:\tes\evoting\resources\views/admin/master/admin.blade.php ENDPATH**/ ?>