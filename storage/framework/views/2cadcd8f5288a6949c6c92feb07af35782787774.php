        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content border-0">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg">
                            <form action="<?php echo e(route('candidate.index')); ?>" enctype="multipart/form-data" method="post" id="formDataCandidate">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-lg">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="file" id="foto" name="foto" accept="image/*" data-src="<?php echo e(Storage::url('candidate')); ?>/">
...
<?php endif; ?><?php /**PATH C:\laragon\www\evoting\resources\views/admin/master/kandidat.blade.php ENDPATH**/ ?>