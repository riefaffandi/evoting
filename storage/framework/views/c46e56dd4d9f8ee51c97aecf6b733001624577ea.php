        ...
        <div class="row h-100 g-0 justify-content-center">
            <div class="col-lg-4 my-auto">
                <div class="card border-0 shadow">
                    ...
                    <div>
                        <small class="text-center">masukkan data sesuai yang ada daftarkan sebelumnya</small>
                    </div>
                    <div class="card-body p-3">
                        <form action="<?php echo e(route('login')); ?>" method="post" id="formLogin">
                            <?php echo csrf_field(); ?>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control text-center fs-5" id="username" name="username" placeholder="username" value="<?php echo e(old('username')); ?>" autofocus required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control text-center fs-5" id="password" name="password" placeholder="password" value="<?php echo e(old('password')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <small class="d-block text-center p-3">Belum Terdaftar? <a href="<?php echo e(route('register')); ?>" class="text-decoration-none fw-bold">Buat Akun!</a></small>
                        </form>
                    </div>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH D:\tes\evoting\resources\views/auth/login.blade.php ENDPATH**/ ?>